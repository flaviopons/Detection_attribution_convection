create_gridded_3d_array_ncei <- function(ncei_data, minlon, maxlon, minlat, maxlat, res) {
  ...
  # 4. Process ncei data into gridded format
  ...
  # Process the data
  gridded_data <- process_data(ncei_data, grid)
...
# Example usage:
#result <- create_gridded_3d_array_ncei(NCEI_hail, -150, -50, 12, 60, 0.25)
